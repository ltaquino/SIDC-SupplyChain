...
# Migration Commands
`dotnet ef migrations add "Initial" --project SIDCSupplyChain.Infrastructure --startup-project SIDCSupplyChain.Api --output-dir Migrations --context IdentityContext

`dotnet ef database update --project SIDCSupplyChain.Infrastructure --startup-project SIDCSupplyChain.Api --context IdentityContext

`dotnet ef migrations add "Initial" --project SIDCSupplyChain.Infrastructure --startup-project SIDCSupplyChain.Api --output-dir Migrations\ApplicationDb --context ApplicationDbContext

`dotnet ef database update --project SIDCSupplyChain.Infrastructure --startup-project SIDCSupplyChain.Api --context ApplicationDbContext
...
[Get the NuGet Package from here!](https://www.nuget.org/packages/SIDCSupplyChain/)
