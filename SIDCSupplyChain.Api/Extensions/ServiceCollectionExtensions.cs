...
using SIDCSupplyChain.Api.Services;
using SIDCSupplyChain.Application.DTOs.Settings;
using SIDCSupplyChain.Application.Interfaces;
...
using SIDCSupplyChain.Infrastructure.Identity.Services;
using SIDCSupplyChain.Infrastructure.Shared.Services;
using System;
using System.Collections.Generic;
using System.Text;

namespace SIDCSupplyChain.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\SIDCSupplyChain.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "SIDCSupplyChain",
