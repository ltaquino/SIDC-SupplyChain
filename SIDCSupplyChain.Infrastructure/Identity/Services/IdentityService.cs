using SIDCSupplyChain.Application.DTOs.Identity;
using SIDCSupplyChain.Application.DTOs.Mail;
using SIDCSupplyChain.Application.DTOs.Settings;
using SIDCSupplyChain.Application.Enums;
using SIDCSupplyChain.Application.Exceptions;
...
namespace SIDCSupplyChain.Infrastructure.Identity.Services
{
